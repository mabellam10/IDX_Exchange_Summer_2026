...
listing_folders = Path("Original_Sold")
listing_files = sorted(listing_folders.glob("CRMLSSold*.csv"))
...
print("\n")
print(f"Original_Sold folder has: {len(listing_files)} files")
...
concentrated_df_c.to_csv("sold_cleaned_dataframe.csv",index=False)